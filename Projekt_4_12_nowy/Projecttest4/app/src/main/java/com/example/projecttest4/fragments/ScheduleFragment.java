...
//        ArrayList<User> allUsersList = uc.getUsers();
//
//        DishController dc = new DishController();
//        ArrayList<Dish> allDishesList = dc.getDishes();

//        if(allDishesList.size() > 0) {
//            tv2.setText(allDishesList.toString());
//        }
//
//        if(userFetchByEmail != null) {
//            tv2.setText(userFetchByEmail.getPosition());
//        }
//
//        if(allUsersList.size() > 0) {
//            tv2.setText(allUsersList.toString());
//        }
